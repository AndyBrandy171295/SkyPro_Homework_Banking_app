...
def test_empty_read_transactions_from_xlsx(mock_read_excel, mock_open):
    ...
    mock_read_excel.assert_called_once_with("transactions_excel.xlsx", dtype=str, engine="openpyxl")
...
def test_read_transaction_from_csv(mock_open):
    ...
    mock_open.assert_called_once_with(os.path.abspath("transactions.csv"), encoding="utf-8")
